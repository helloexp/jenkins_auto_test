...
class AdsPlatformMasterServiceTest extends BaseSpringBootTest {

    @Nested
    public class FindByIdTest {

        @Autowired
        private AdsPlatformMasterService adsPlatformMasterService;

        @Test
        @Sql("/services/AdsPlatformMasterServiceTest/FindByIdTest/m_ads_pltfrm.sql")
        public void expectingFindSuccess_givingManyCases() {
            AdsPlatformMaster adsPlatformMaster = adsPlatformMasterService.findById(1001L);
            ...
            adsPlatformMaster = adsPlatformMasterService.findById(1002L);
            ...
            // Not found
            adsPlatformMaster = adsPlatformMasterService.findById(9999L);
            assertThat(adsPlatformMaster).isEqualTo(null);

            // Null
            adsPlatformMaster = adsPlatformMasterService.findById(null);
            assertThat(adsPlatformMaster).isEqualTo(null);
        }
    }
}
