...
public class SegmentUpdateResponse extends BaseResponse {

    public SegmentUpdateResponseDto targetSegment;

    public SegmentUpdateResponse(Segment segment, List<SegmentCondition> conditionList) {
        this.targetSegment = new SegmentUpdateResponseDto(segment, conditionList);
    }
    ...
    public static class SegmentUpdateResponseDto extends BaseAuditResponse {
        ...
        public SegmentUpdateResponseDto(Segment segment, List<SegmentCondition> conditionList) {
